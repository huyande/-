...
INSERT INTO `qw_auth_rule` VALUES ('108', '0', '', '表白墙', 'menu-icon fa fa-desktop', '1', '1', '', '1', '14', '');
...
CREATE TABLE `qw_xcxbb_guanzhu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1225 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `qw_xcxbb_list` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=548 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `qw_xcxbb_message` (
  ...
  `time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=168 DEFAULT CHARSET=utf8mb4;
